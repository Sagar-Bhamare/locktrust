...
const DomesticBeneficiaryForm = ({ open, onClose, onSubmit }) => {
  ...
  const handleSubmit = () => {
    ...
    onSubmit(formData)
    toast.success('Domestic beneficiary added successfully!')
    setFormData({
      recipientType: 'individual',
      beneficiaryName: '',
      nickname: '',
    ...
    <Dialog open={open} onClose={onClose} maxWidth='md' fullWidth>
      <DialogTitle>
        <Box display='flex' justifyContent='space-between' alignItems='center'>
          <Typography variant='h5' sx={{ fontWeight: 600 }}>Domestic Recipient</Typography>
...
export default DomesticBeneficiaryForm