...
const OutgoingFees = ({ data, onUpdate }) => {
  const feeItems = [
    { key: 'ach', label: 'ACH' },
    { key: 'wire', label: 'Wire' },
    ...
    { key: 'escrowCancellation', label: 'Escrow Cancellation' }
  ]

  return (
    <Card>
      <CardHeader title='Outgoing Fees' subheader='Fees applied to outgoing transactions' />
      <TableContainer>
        <Table>
          <TableHead>
            <TableRow
