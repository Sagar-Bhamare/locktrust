...
const LoanBatchUploadDialog = ({ open, onClose, onUpload, onDownloadTemplate }) => {
  ...
  return (
    <>
      <Dialog open={open} onClose={onClose} maxWidth='sm' fullWidth>
        <DialogTitle>Loan Batch Upload</DialogTitle>
        <DialogContent>
          <Box sx={{ mt: 2 }}>
            <Alert severity='info' sx={{ mb: 3 }}>
              Upload multiple loan requests at once using CSV/Excel file.
...
export default LoanBatchUploadDialog
